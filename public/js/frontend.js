//Non-functioning frontend.js file
//Search is done in a script tag in nav.hbs file
...
function executeSearch() {
    ...
    //let searchURL = `localhost:3000/?search-text=${searchTerm}&search-button=${searchTerm}`;
    fetch(searchURL)
    .then((data) => {
        return data.json();
    })
